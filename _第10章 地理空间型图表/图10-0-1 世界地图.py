...
ax = geoplot.polyplot(
    world, projection=geoplot.crs.Orthographic(
        central_longitude=90.0, central_latitude=0.0),
    figsize=(8, 4))
geoplot.choropleth(
...
basemap.drawmeridians(np.arange(
    basemap.lonmin, basemap.lonmax+30, 60), labels=[0, 0, 0, 1], zorder=0)
plt.show()
